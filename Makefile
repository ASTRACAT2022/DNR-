...
pkgdatadir = $(datadir)/dnr
pkgincludedir = $(includedir)/dnr
pkglibdir = $(libdir)/dnr
pkglibexecdir = $(libexecdir)/dnr
...
top_srcdir = .
SUBDIRS = src
systemdsystemunit_DATA = dnr.service
all: config.h
